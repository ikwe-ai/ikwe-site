...
|------|---------|---------------|
| `ikwe-shared.css` | **Shared nav, footer, palette, typography for all pages** | Site root — `<link rel="stylesheet" href="/ikwe-shared.css">` |
| `ikwe-tokens-final.css` | Design tokens reference (colors, spacing vars) | Reference doc — shared.css is the deploy file |
...
| `about.html` | About page (trust-first, no bio energy) | Replaces `about.html` in repo |
| `research.html` | Research & methodology page | Replaces `research.html` in repo |
| `proof.html` | Proof page (evidence + reduction data) | Replaces `proof.html` in repo |
| `enterprise.html` | For Teams / Enterprise page | Replaces `enterprise.html` in repo |
